...
function laboratoria_page_shortcode() {
    ...
    <div class="lab-intro-text">
      ...
      <p>Siguiendo el objetivo de crear una estrategia de incidencia feminista, para iniciar el trabajo de la Laboratoria se plantearon tres ejes de acción: 1) comunicación; 2) experimentación; y 3) vinculación. Conformados a su vez por iniciativas específicas orientadas a su operación en el corto y mediano plazo.</p>
    ...
    ob_start();
    ?>
      <p>Editatona <em>Feministas del Sur Global</em> en colaboración con Wikimedia México<br>
      Fecha: 29 de abril de 2025<br>
      Duracion: 6 horas<br>
      Propósito: visibilizar los aportes y las trayectorias de mujeres feministas de distintas latitudes de las coordenadas geopolíticas que conforman el Sur Global, contribuyendo así a la divulgación de nuestra genealogía política y a disminuir la brecha de género en Wikipedia.</p>
    ...
    ob_start();
    ?>
      <p>Taller <em>Uso de QualCoder en la investigación feminista</em><br>
      Fecha: 18 de septiembre de 2025<br>
      Duracion: 3 horas<br>
      Propósito: brindar, a través de una capacitación introductoria al software QualCoder, herramientas prácticas para la codificación de materiales textuales y el análisis de datos cualitativos a partir de categorías, subcategorías y códigos deductivos e inductivos.</p>
    <?php
    $act3 = ob_get_clean();

    ob_start();
    ?>
      <p>Con la incorporación de la Dra. Agnes del Rosario Jiménez Romo como investigadora posdoctoral en el PEIF, todavía durante este 2025, se llevará a cabo una actividad como parte del eje de acción comunicación de la Laboratoria que será liderada por ella:</p>
      <p>Taller <em>Herramientas de comunicación digital feminista</em></p>
      <ul>
        <li>Fecha: 03 al 06 de noviembre de 2025<br>
        Duracion: 12 horas<br>
        Propósito: Construir de manera participativa, una estrategia de comunicación digital feminista que refleje los principios del posgrado: pensamiento crítico, la ética del cuidado y el trabajo colectivo. El taller está organizado para que las estudiantes del PEIF exploren herramientas prácticas con bases teóricas, reconociendo que las redes sociodigitales no solo son espacios de difusión, sino también, territorios de encuentro, reflexión e intervención.</li>
      </ul>
    <?php
    $act4 = ob_get_clean();
