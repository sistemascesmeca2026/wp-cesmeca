				...
				<tr>
					<th scope="row"><?php _e('Archived categories:', 'fg-joomla-to-wordpress'); ?></th>
					<td>
						<input id="archived_categories_not_imported" name="archived_categories" type="radio" value="not_imported" <?php checked($data['archived_categories'], 'not_imported'); ?> /> <label for="archived_categories_not_imported" title="<?php _e("Do not import archived categories", 'fg-joomla-to-wordpress'); ?>"><?php _ex('Not imported', 'categories', 'fg-joomla-to-wordpress'); ?></label>&nbsp;&nbsp;
						<input id="archived_categories_imported" name="archived_categories" type="radio" value="imported" <?php checked($data['archived_categories'], 'imported'); ?> /> <label for="archived_categories_imported" title="<?php _e("Import archived categories", 'fg-joomla-to-wordpress'); ?>"><?php _ex('Imported', 'categories', 'fg-joomla-to-wordpress'); ?></label>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php _e('Unpublished categories:', 'fg-joomla-to-wordpress'); ?></th>
					<td>
						<input id="unpublished_categories_not_imported" name="unpublished_categories" type="radio" value="not_imported" <?php checked($data['unpublished_categories'], 'not_imported'); ?> /> <label for="unpublished_categories_not_imported" title="<?php _e("Do not import unpublished categories", 'fg-joomla-to-wordpress'); ?>"><?php _ex('Not imported', 'categories', 'fg-joomla-to-wordpress'); ?></label>&nbsp;&nbsp;
						<input id="unpublished_categories_imported" name="unpublished_categories" type="radio" value="imported" <?php checked($data['unpublished_categories'], 'imported'); ?> /> <label for="unpublished_categories_imported" title="<?php _e("Import unpublished categories", 'fg-joomla-to-wordpress'); ?>"><?php _ex('Imported', 'categories', 'fg-joomla-to-wordpress'); ?></label>
					</td>
				</tr>
				<tr>
...
<?php endif; ?>
						...
						<br />
						<input id="skip_thumbnails" name="skip_thumbnails" type="checkbox" value="1" <?php checked($data['skip_thumbnails'], 1); ?> /> <label for="skip_thumbnails"><?php _e("Don't generate the thumbnails", 'fg-joomla-to-wordpress'); ?></label>
						<br />
						<input id="import_external" name="import_external" type="checkbox" value="1" <?php checked($data['import_external'], 1); ?> /> <label for="import_external"><?php _e('Import the external media stored outside your site', 'fg-joomla-to-wordpress'); ?></label>
						<br />
						<input id="import_duplicates" name="import_duplicates" type="checkbox" value="1" <?php checked($data['import_duplicates'], 1); ?> /> <label for="import_duplicates" title="<?php _e('Checked: download the media with their full path in order to import media with identical names.', 'fg-joomla-to-wordpress'); ?>"><?php _e('Import the media with duplicate names', 'fg-joomla-to-wordpress'); ?></label>
						<br />
						<input id="force_media_import" name="force_media_import" type="checkbox" value="1" <?php checked($data['force_media_import'], 1); ?> /> <label for="force_media_import" title="<?php _e('Checked: download the media even if it has already been imported. Unchecked: Download only media which were not already imported.', 'fg-joomla-to-wordpress'); ?>" ><?php _e('Force media import. <small>Keep unchecked except if you had previously some media download issues.</small>', 'fg-joomla-to-wordpress'); ?></label>
						<br />
						<?php _e('Timeout for each media:', 'fg-joomla-to-wordpress'); ?>&nbsp;
						<input id="timeout" name="timeout" type="text" size="5" value="<?php echo esc_attr($data['timeout']); ?>" /> <?php _e('seconds', 'fg-joomla-to-wordpress'); ?>
					</div></td>
				</tr>
				<tr>
