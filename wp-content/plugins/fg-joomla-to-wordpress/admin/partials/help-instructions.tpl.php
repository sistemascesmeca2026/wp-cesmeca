...
<h2>Import in command line by WP CLI <span class="fgj2wp_premium_feature">(Premium feature)</span></h2>
...
<p>Here are the WP CLI commands that you can use:
	<ul>
		<li><strong>wp import-joomla empty</strong> : Empty the imported data</li>
		<li><strong>wp import-joomla empty all</strong> : Empty all the WordPress data</li>
		<li><strong>wp import-joomla test_database</strong> : Test the database connection</li>
		<li><strong>wp import-joomla test_media</strong> : Test the media connection</li>
		<li><strong>wp import-joomla import</strong> : Import the data</li>
		<li><strong>wp import-joomla modify_links</strong> : Modify the internal links</li>
	</ul>
</p>
